...
namespace CMCSApplication.Migrations
{
    ...
    [Migration("20251121023139_AddDepartmentAndUserDepartmentFields")]
    partial class AddDepartmentAndUserDepartmentFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMCSApplication.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CMCSApplication.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CMCSApplication.Models.Lecturer", b =>
                {
                    b.HasOne("CMCSApplication.Models.Department", "DepartmentRef")
                        .WithMany()
            ...
            modelBuilder.Entity("CMCSApplication.Models.User", b =>
                {
                    b.HasOne("CMCSApplication.Models.Department", "Department")
                        .WithMany()
                        .HasForeignKey("DepartmentId");
